// Файл: Application/Messages/Commands/UpdateMessageCommandValidator.cs
    ...
    public class UpdateMessageCommandValidator : AbstractValidator<UpdateMessageCommand>
    {
        public UpdateMessageCommandValidator()
        {
            ...
            RuleFor(x => x.Text)
                ...
                .MaximumLength(1000).WithMessage("Текст повідомлення не може перевищувати 1000 символів."); // Відповідає CreateMessageCommandValidator
        }
    }
}