...
{
    public record RegisterUserCommand : IRequest<Result<User, UserException>>
    {
    ...
    {
        public async Task<Result<User, UserException>> Handle(RegisterUserCommand request, CancellationToken cancellationToken)
        {
            ...
            CancellationToken cancellationToken)
        {
            ...
            {
                UserException opFailedException = new UserOperationFailedException(newUserId, "RegisterUser", exception);
